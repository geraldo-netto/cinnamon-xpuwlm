...
The GPU use-case implementation backlog is tracked directly in XTPU-0099
...
| XTPU-0099 | open | high | l | XTPU-0095 | Version reusable closed result schemas for risk scores, forecasts, rankings, detections, masks, embeddings, labels, and timestamped media evidence. |
...
| XTPU-0134 | open | medium | l | XTPU-0099, XTPU-0100, XTPU-0101, XTPU-0102 | Implement presentation review for selected PPTX, ODP, and PDF inputs using slide-order-preserving text/visual evidence; return editable slide-bound observations, notes, accessibility text, and questions. |
| XTPU-0135 | open | medium | l | XTPU-0099, XTPU-0100, XTPU-0103, XTPU-0134 | Implement presentation planning through a validated editable deck intermediate and explicit PPTX/ODP export; keep selected-source scope and every write under confirmation. |
| XTPU-0136 | open | medium | l | XTPU-0098, XTPU-0099, XTPU-0102, XTPU-0134 | Implement rehearsal/meeting briefing by aligning speech timestamps, sampled frames, and slide changes into evidence-bound transcript, timing, summary, decisions, proposed tasks, questions, and events. |
