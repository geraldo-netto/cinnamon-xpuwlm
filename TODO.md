...
| XTPU-0090 | open | low | xs | XTPU-0087 | The popup-open comment in `applet.js` still says runtime input listing is synchronous after XTPU-0083 made production enumeration asynchronous. Correct the lifecycle comment without changing behavior. |
