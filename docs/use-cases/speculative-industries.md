# Speculative ideas: media, commerce, and industry

[Previous: Computing and communication](speculative-computing.md) · [Speculative idea index and cautions](../use-cases.md#speculative-idea-bank) · [Documentation index](../../README.md) · [Next: People, science, and environment](speculative-people-and-science.md)
