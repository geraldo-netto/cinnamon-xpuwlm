...
- [Use cases and practicality](docs/use-cases.md)
  - [Use-case catalog](docs/use-cases.md#use-case-catalog)
  - [Image similarity and visual search](docs/use-cases.md#image-similarity-and-visual-search)
  - [Speculative and extrapolated idea bank](docs/use-cases.md#speculative-and-extrapolated-idea-bank)
  - [Practicality by workload](docs/use-cases.md#practicality-by-workload)
