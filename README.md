...
- [Deployment, safety, and references](docs/deployment.md)
  ...
  - [Install order](docs/deployment.md#install-order)
    - The client-side sequence and the `xpuwlm verify` check that proves the
      three installed pieces agree live with the client, in `../xpuwlm/docs/install.md`
