...
- [Documentation and maintenance status](#documentation-and-maintenance-status)
- [How to read the evidence](#how-to-read-the-evidence)
- [What the Edge TPU is](#what-the-edge-tpu-is)
- [What the Edge TPU is not](#what-the-edge-tpu-is-not)
- [What it can and cannot do](#what-it-can-and-cannot-do)
- [Execution boundary](#execution-boundary)
- [Model compatibility](#model-compatibility)
- [Memory, performance, and scaling](#memory-performance-and-scaling)
- [Use-case catalog](#use-case-catalog)
- [Image similarity and visual search](#image-similarity-and-visual-search)
- [Speculative and extrapolated idea bank](#speculative-and-extrapolated-idea-bank)
- [Practicality by workload](#practicality-by-workload)
- [Hardware integration](#hardware-integration)
- [Software setup](#software-setup)
- [Cinnamon applet integration](#cinnamon-applet-integration)
- [Virtualization](#virtualization)
- [Deployment and evaluation workflow](#deployment-and-evaluation-workflow)
